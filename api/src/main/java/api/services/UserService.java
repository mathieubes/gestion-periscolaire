...
public class UserService {
  ...
  private void initFakeParents() {
    final var test = addParent(new UserPostDTO("Mathieu", "BES", "test", "test@test.fr", "surLaA6", "06qlqchose"));
    test.addChild(new Child("Pedro", "Italian", new Date(), Gender.MALE, true));
    test.addChild(new Child("Sara", "Mexican", new Date(), Gender.FEMALE, false));
    ...
    final var florian = addParent(
        new UserPostDTO("Florian", "CARBONI", "pd", "mario.flo@hotmail.fr", "versRis", "118 218"));
